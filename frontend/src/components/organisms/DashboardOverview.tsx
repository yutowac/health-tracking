    ...
    <div>
      <div className="bg-gradient-to-br from-[#e8f0ff] via-[#f0e8ff] to-[#ffe8f4] rounded-[28px] p-7 shadow-[0_12px_40px_rgba(0,31,77,0.1),0_4px_12px_rgba(0,0,0,0.05)]">
        <div className="flex gap-6">
          <div className="flex-[1.3] bg-white/80 backdrop-blur-sm rounded-[22px] p-7 shadow-[0_8px_24px_rgba(11,36,67,0.08)]">
          ...
          <div className="flex-1 flex flex-col gap-6">
            <button
              ...
              className="bg-gradient-to-br from-accent-purple to-accent-purple-light rounded-[20px] p-5 flex items-center justify-center gap-4 shadow-[0_6px_20px_rgba(107,92,231,0.3)] active:scale-[0.98] transition-transform"
            >
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-[20px] p-6 flex-1 shadow-[0_8px_24px_rgba(11,36,67,0.08)]">
              <h4 className="text-primary-dark font-semibold text-[15px] mb-5">News</h4>
